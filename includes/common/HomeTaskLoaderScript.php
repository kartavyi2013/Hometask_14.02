...
class HomeTaskLoaderScript
{
    ...
    public function loadScriptAdmin($hook){
        ...
        wp_register_script(
            HOMETASKSHORTCODE_PlUGIN_SLUG.'-AdminMain', //$handle
            HOMETASKSHORTCODE_PlUGIN_URL.'assets/admin/js/HomeTaskAdminMain.js', //$src
            array(
                'jquery'
            ), //$deps
            HOMETASKSHORTCODE_PlUGIN_VERSION, //$ver
            true //$$in_footer
        );
        /**
         ...
         */
        wp_enqueue_script(HOMETASKSHORTCODE_PlUGIN_SLUG.'-AdminMain');
        ...
        wp_register_style(
            HOMETASKSHORTCODE_PlUGIN_SLUG.'-AdminMain', //$handle
            HOMETASKSHORTCODE_PlUGIN_URL.'assets/admin/css/HomeTaskAdminMain.css', // $src
            array(), //$deps,
            HOMETASKSHORTCODE_PlUGIN_VERSION // $ver
        );
        /**
         ...
         */
        wp_enqueue_style(HOMETASKSHORTCODE_PlUGIN_SLUG.'-AdminMain');
    ...
    public function loadHeadScriptAdmin(){
        ?>
            <script type="text/javascript">
                ...
                HomeTaskAjaxUrl  = '<?php echo HOMETASKSHORTCODE_PlUGIN_AJAX_URL; ?>';
            </script>
        <?php
    }
